...
$result8 = $memcache->set('load_test_key1', 'test-030-03', false, 1);	// hashes to $host2
$result9 = $memcache->set('load_test_key2', 'test-030-04', false, 1);	// hashes to $host1

var_dump($result8);
var_dump($result9);

$result10 = $memcache1->get('load_test_key1');	// key should be $host1 (failed over from $host2)
$result11 = $memcache1->get('load_test_key2');	// key should always be at $host1
